...
open class KeychainSwift {
     ...
     */
    @discardableResult
    open func set(_ value: String, forKey key: DZAKeychainKey,
     ...
     */
    @discardableResult
    open func set(_ value: Data, forKey key: DZAKeychainKey,
                  withAccess access: KeychainSwiftAccessOptions? = nil) -> Bool {
     ...
     */
    @discardableResult
    open func set(_ value: Bool, forKey key: DZAKeychainKey,
                  withAccess access: KeychainSwiftAccessOptions? = nil) -> Bool {
     ...
     */
    open func get(_ key: DZAKeychainKey) -> String? {
     ...
     */
    open func getData(_ key: DZAKeychainKey, asReference: Bool = false) -> Data? {
        // The lock prevents the code to be run simlultaneously
        // from multiple threads which may result in crashing
        lock.lock()
        defer { lock.unlock() }
     ...
     */
    open func getBool(_ key: DZAKeychainKey) -> Bool? {
     ...
     */
    @discardableResult
    open func delete(_ key: DZAKeychainKey) -> Bool {
        // The lock prevents the code to be run simlultaneously
        // from multiple threads which may result in crashing
        lock.lock()
        defer { lock.unlock() }
     ...
     */
    @discardableResult
    func deleteNoLock(_ key: DZAKeychainKey) -> Bool {
        let prefixedKey = keyWithPrefix(key)
    ...
    func keyWithPrefix(_ key: DZAKeychainKey) -> String {
        return "\(keyPrefix)\(key.keyString)"
    }
